...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAIN_WIN] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
                          M_HESC,  M_LALTE, KC_LCTL, KC_SPC,           M_NUMRD, M_MVMTW, M_NUMP,  M_HESC
    ),
    [_MVMT_WIN] = LAYOUT(
    ...
    [_MAIN_MAC] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
                          M_HESC,  M_LALTE, KC_LGUI, KC_SPC,           M_NUMRD, M_MVMTM, M_NUMP,  M_HESC
    ),
    [_MVMT_MAC] = LAYOUT(
    ...
    [_HYPR] = LAYOUT(
        KC_CAPS, KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,            KC_TRNS, KC_PSCR, KC_BRMD, KC_BRMU, KC_WBAK, KC_WFWD,
        KC_TRNS, KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8,            KC_TRNS, KC_VOLD, KC_MUTE, KC_VOLU, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, M_TGLM,
